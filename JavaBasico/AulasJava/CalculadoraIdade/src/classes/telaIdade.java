...
public class telaIdade extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        spinner.setModel(new javax.swing.SpinnerNumberModel(1500, 1500, 2022, 1));
        ...
        labelResultado.setForeground(new java.awt.Color(204, 0, 0));
    ...
    private void btnCalcularActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCalcularActionPerformed
        ...
        int anoNasc = Integer.parseInt(spinner.getValue().toString());
        int idade = 2022 - anoNasc;
        
        labelResultado.setText(Integer.toString(idade));
